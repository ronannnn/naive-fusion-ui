  ...
  const opts: DropdownOption[] = [
    {
      key: 'closeAll',
      label: '关闭全部',
      icon: () => h('div', { class: 'iconify tabler--x' }),
    },
    {
      key: 'closeOther',
      label: '关闭其他',
      icon: () => h('div', { class: 'iconify tabler--arrow-bar-both' }),
    },
    {
      key: 'closeLeft',
      label: '关闭左侧',
      icon: () => h('div', { class: 'iconify tabler--arrow-bar-left' }),
    },
    {
      key: 'closeRight',
      label: '关闭右侧',
      icon: () => h('div', { class: 'iconify tabler--arrow-bar-right' }),
    },
    {
      key: 'closeCurrent',
      label: '关闭当前',
      icon: () => h('div', { class: 'iconify tabler--circle-x' }),
    },
  ]
  return opts
})
