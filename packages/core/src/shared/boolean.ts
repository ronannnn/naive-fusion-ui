...
function useUploading(initValue = false) {
...
function useQuerying(initValue = false) {
  const { bool: querying, setTrue: startQuerying, setFalse: endQuerying } = useBoolean(initValue)
...
export { useBoolean, useDeleting, useDownloading, useExporting, useFetching, useLoading, useLoadingFn, useQuerying, useSearching, useSubmitting, useUploading }
